...
<p align="left"> Thus <img src="https://render.githubusercontent.com/render/math?math=$|\Omega|=2^{n}$">. The sum is a linear combination of the <img src="https://render.githubusercontent.com/render/math?math=$n$"> simultaneous GoL. </p>
